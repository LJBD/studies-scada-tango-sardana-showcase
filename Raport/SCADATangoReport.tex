...
\textsc{Akademia Górniczo - Hutnicza w Krakowie}\\[1mm] % Your institution
%\vspace{-5mm}
}
...
\input{podstawa_teoretyczna}

\input{koncepcja_realizacji}

\input{specyfikacja_sprzetu}

\input{specyfikacja_programow}

\input{opis_realizacji}
